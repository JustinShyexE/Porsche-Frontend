...
function SignUp() {
  ...
  var submit = async (e) => {
    if (data.password1 !== data.password2 || !data.password1 || !data.password2) {
      ...
      await fetch("https://porsche-backend-mmny.onrender.com/signup", {
        method: "POST",
        headers: {
    ...
    <div className="mainSignupBody">
      ...
      <div className="signupBody">
        <div className="signupContainer">
          ...
          <p className="roboto signupText signupP">
            Become part of the Porsche family and create your Porsche ID. Your key to all Porsche
          ...
          <div className="signupContainer760px">
            <Input
              type="text"
              text="Salutation*"
              placeholder="Miss Mr. Mrs. Ms. ..."
              classNameP="signupGap signupDiv1"
              className="loginInput signupInput signupDiv1 singnupInBar"
            />
            <Input
              type="text"
              text="Title*"
              placeholder="Dr. Prof. MA. BSc. BEng..."
              classNameP="signupGap signupDiv2"
              className="loginInput signupInput signupDiv2 singnupInBar"
            />
          </div>
          <div className="signupContainer760px">
            <div className="signupInputDiv signupDiv3">
              ...
              <input
                ...
                inputMode="email"
                type="text"
                className="loginInput signupInput signupDiv3 singnupInBar"
                required
              />
            </div>
            <div className="signupInputDiv signupDiv4">
              ...
              <input
                ...
                inputMode="email"
                type="text"
                className="loginInput signupInput signupDiv4 singnupInBar"
              />
            </div>
          </div>
          <div className="signupContainer760px">
          ...
          {match ? (
            <h1 style={{ color: "red", fontFamily: "roboto", fontSize: "18px", fontWeight: "400" }}>
              Passwords don't match!
            </h1>
          ) : null}
          {empty ? (
            <h1 className="MuiFormLabel-root MuiFormLabel-colorGrey Mui-error Mui-required css-sbdo8b-MuiFormLabel-root">
      ...
      */}
          ...
          <div style={{ marginLeft: "-30px", paddingRight: "50px" }}>
            ...
            <FormControl
              ...
              variant="standard"
            >
              <FormLabel color="grey" component="primary">
          ...
          <ClickableButton
            onChecked={submit}
            className="loginInput loginButton signupInput signupButton"
            text="Create Porsche Account"
          />
          <p
            style={{ fontWeight: 500, marginTop: "30px", marginBottom: "0px" }}
            className="roboto signupP2"
          >
            This website is protected by Friendly Captcha and is subject to the{" "}
            <a className="inputAnchor" href="/">
              Privacy Policy
            </a>{" "}
            and{" "}
            <a className="inputAnchor" href="/">
