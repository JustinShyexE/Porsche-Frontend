    ...
    <div>
      <div className="header">
        <div className="btn1_position">
          <div onMouseOver={handleExpand1}>
            <Button text="Models" />
          </div>
          <div onMouseOver={ExpandOff}>
            <Button text="Shop" />
          </div>
          <div onMouseOver={handleExpand2}>
            <Button text="Vehicle Purchase" />
          </div>
          <div onMouseOver={handleExpand3}>
        ...
        {isExpanded ? (
          <div onMouseLeave={ExpandOff} className="underHeaderON">
            {whichButton[0] === 1 ? (
              <div className="Row1">
          ...
          <div className="underHeaderOFF"></div>
        )}
        <a href="/login-password/email/password">
          <img src={user} className="accountIcon" alt="userIcon" />
          {/*<AccountCircleIcon style={{ color: 'white', fontSize: '30'}} className="accountIcon" />*/}
        </a>
        <Icon />
      </div>
    </div>
