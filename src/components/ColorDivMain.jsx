...
function ColorDivMain(props){
      ...
      <div className="customBoxes">
         <div onClick={() => props.onChecked(props.images1, props.price, props.title, props.colorName1)} style={{width:"100%"}}>
            <ColorDiv colorName={props.colorName1} colorCode={props.colorCode1} />
         </div>
         <div  onClick={() => props.onChecked(props.images2, props.price, props.title, props.colorName2)}
           style={{width:"100%"}}>
         {props.colorName2?
